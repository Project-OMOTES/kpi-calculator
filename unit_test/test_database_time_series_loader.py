...
class TestDatabaseTimeSeriesLoader(unittest.TestCase):
    ...
    def test_init_with_default_credential_manager(self):
        ...
        with patch('src.kpicalculator.adapters.database_time_series_loader.create_default_credential_manager') as mock_create:
            mock_manager = Mock()
    ...
    def test_load_profile_data_success(self, mock_validator, mock_profile_manager):
        ...
        mock_profile_manager.create_esdl_influxdb_profile_manager.return_value = mock_time_series_data
    ...
    def test_get_credentials_for_profile_ssl_port_443(self):
        ...
        non_ssl_credentials = DatabaseCredentials(
            host="test.example.com", port=443, username="user", password="pass",
            database="db", ssl=False, verify_ssl=True
        )
    ...
    def test_convert_units_power(self):
        ...
        with patch('src.kpicalculator.adapters.database_time_series_loader.convert_to_unit') as mock_convert:
    ...
    def test_load_time_series_from_esdl_success(self, mock_time):
        ...
        energy_system.eAllContents.return_value = [profile1, profile2, Mock()]  # Third is not InfluxDBProfile
