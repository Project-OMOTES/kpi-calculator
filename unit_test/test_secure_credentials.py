...
from src.kpicalculator.exceptions import SecurityError, CredentialError, ConfigurationError
...
class TestConfigFileCredentialManager(unittest.TestCase):
    ...
    @patch('src.kpicalculator.security.credential_manager.ConfigFileCredentialManager._validate_file_permissions')
