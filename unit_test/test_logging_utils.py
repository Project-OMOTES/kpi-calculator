...
from src.kpicalculator.common.logging_utils import (
    StructuredLogger, DatabaseLogger, SecurityLogger,
    get_database_logger, get_security_logger
)
...
class TestSecurityLogger(unittest.TestCase):
    ...
    def test_log_security_threat(self):
        ...
        self.security_logger.log_security_threat(
            "xxe_attack", "malicious.xml", details, "critical"
        )
