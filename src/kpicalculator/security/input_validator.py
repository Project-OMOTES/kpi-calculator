...
class InputValidator:
    ...
    def validate_file_path(file_path: Union[str, Path], 
        ...
        try:
            ...
            raise ValidationError(f"Invalid file path format: {file_path}", context={'error': str(e)})
        ...
        try:
            ...
            raise ValidationError(f"Cannot resolve file path: {file_path}", context={'error': str(e)})
    ...
    def validate_asset_properties(asset_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        cost_fields = [
            'investment_cost', 'installation_cost', 'fixed_operational_cost',
            'variable_operational_cost', 'fixed_maintenance_cost', 'variable_maintenance_cost'
        ]
    ...
    @staticmethod
    def validate_time_series_data(time_series_data: List[float], 
                                field_name: str = "time_series") -> List[float]:
